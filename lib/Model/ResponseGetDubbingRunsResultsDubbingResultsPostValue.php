<?php
/**
 * ResponseGetDubbingRunsResultsDubbingResultsPostValue
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseGetDubbingRunsResultsDubbingResultsPostValue Class Doc Comment
 *
 * @category Class
 * @package  Camb.ai
 * @author   OpenAPI Generator team
 ...
 */
class ResponseGetDubbingRunsResultsDubbingResultsPostValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Get_Dubbing_Runs_Results_Dubbing_Results_Post_value';
    ...
    protected static $openAPITypes = [
        'audio_url' => 'string',
        'transcript' => '\Camb.ai\Model\Transcript[]',
        'video_url' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['audio_url'] === null) {
            $invalidProperties[] = "'audio_url' can't be null";
        }
     ...
     * Gets transcript
     *
     * @return \Camb.ai\Model\Transcript[]
     */
     ...
     * Sets transcript
     *
     * @param \Camb.ai\Model\Transcript[] $transcript transcript
     *
     * @return self
     */
