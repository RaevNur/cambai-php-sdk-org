...
| ------------- | ------------- | ------------- |
| [**createTextToAudioTextToSoundPost()**](TextToSoundApi.md#createTextToAudioTextToSoundPost) | **POST** /text-to-sound | Create Text To Audio |
| [**getTextToAudioResultTextToSoundResultRunIdGet()**](TextToSoundApi.md#getTextToAudioResultTextToSoundResultRunIdGet) | **GET** /text-to-sound-result/{run_id} | Get Text To Audio Result |
| [**getTextToAudioStatusTextToSoundTaskIdGet()**](TextToSoundApi.md#getTextToAudioStatusTextToSoundTaskIdGet) | **GET** /text-to-sound/{task_id} | Get Text To Audio Status |
| [**getTextToSoundResultsTextToSoundResultsPost()**](TextToSoundApi.md#getTextToSoundResultsTextToSoundResultsPost) | **POST** /text-to-sound-results | Get Text To Sound Results |
...
$apiInstance = new Camb.ai\Api\TextToSoundApi(
...
try {
    ...
    echo 'Exception when calling TextToSoundApi->createTextToAudioTextToSoundPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TextToSoundApi->getTextToAudioResultTextToSoundResultRunIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TextToSoundApi->getTextToAudioStatusTextToSoundTaskIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TextToSoundApi->getTextToSoundResultsTextToSoundResultsPost: ', $e->getMessage(), PHP_EOL;
}
```
