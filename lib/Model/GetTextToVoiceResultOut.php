...
/**
 * GetTextToVoiceResultOut Class Doc Comment
 *
 * @category Class
 * @package  Camb.ai
 * @author   OpenAPI Generator team
 ...
 */
class GetTextToVoiceResultOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTextToVoiceResultOut';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['previews'] === null) {
            $invalidProperties[] = "'previews' can't be null";
        }
     ...
     * Sets previews
     *
     * @param string[] $previews previews
     *
     * @return self
     */
