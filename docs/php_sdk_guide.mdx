...
Initialize the client with your custom hosting provider implementation. [Baseten Provider Example](https://github.com/Camb-ai/cambai-php-sdk/blob/master/examples/baseten_provider_example.php)
