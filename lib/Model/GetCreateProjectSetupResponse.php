...
/**
 * GetCreateProjectSetupResponse Class Doc Comment
 *
 * @category Class
 * @package  Camb.ai
 * @author   OpenAPI Generator team
 ...
 */
class GetCreateProjectSetupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCreateProjectSetupResponse';
    ...
    protected static $openAPITypes = [
        'run_id' => 'int',
        'project_details' => '\Camb.ai\Model\ProjectDetails'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('project_details', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['project_details'] === null) {
            $invalidProperties[] = "'project_details' can't be null";
        }
     ...
     *
     * @return \Camb.ai\Model\ProjectDetails
     */
     ...
     *
     * @param \Camb.ai\Model\ProjectDetails $project_details project_details
     *
     * @return self
     */
    public function setProjectDetails($project_details)
    {
        if (is_null($project_details)) {
            throw new \InvalidArgumentException('non-nullable project_details cannot be null');
        }
